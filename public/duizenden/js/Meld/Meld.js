class Meld {
    constructor(z_fighter, cards, container, card_width, card_height, card_separation, path_extend_meld, angle_offset) {
        ...
        this.card_fan = new Fan(this.meld_container, card_separation, card_width, card_height, false, 0, -this.getOffsetX(card_width), true, angle_offset, z_fighter, false, false);
