class Meld {
    constructor(z_fighter, cards, container, card_width, card_height, card_separation, path_extend_meld) {
        ...
        this.card_fan = new Fan(this.meld_container, card_separation, card_width, card_height, false, offset_y, -offset_x, true, 180, z_fighter, false);
