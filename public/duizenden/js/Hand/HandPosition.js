class HandPosition {
    constructor(cards, card_overlap, card_width, card_height) {
        this.cards = cards;
    ...
    setup() {
        ...
        let center_y_offset = this.radius - (this.card_height * 1.80);
        this.center_y = center_y_offset + Math.floor(this.card_height / 2);
        this.center_x = -Math.floor(this.card_width / 2);
    ...
    positionCards() {
        ...
        this.cards.each((i, element) => {
            let add_deviation = this.card_count !== 1;
